...
__all__ = [
    'SGDSActive', 'SVP_9', 'DISPID_SOTCEnumerateTokens',
    'SREAdaptation', 'DISPID_SPISaveToMemory', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPIAudioSizeTime', 'DISPID_SBSSeek',
    'DISPID_SDKGetBinaryValue', 'SREAudioLevel', 'SRTExtendableParse',
    'STCAll', 'DISPID_SLPs_NewEnum', 'DISPID_SABufferInfo',
    'SPGS_DISABLED', 'SPBO_PAUSE', 'DISPID_SRRTOffsetFromStart',
    'SPPARTOFSPEECH', 'DISPID_SpeechPhraseReplacement',
    'SP_VISEME_11', 'SVP_19', 'SpeechRetainedAudioOptions',
    'ISpObjectTokenCategory', 'SpNullPhoneConverter', 'SP_VISEME_15',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechAllElements',
    'SpeechVoiceSkipTypeSentence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPSNoun',
    'DISPID_SPCIdToPhone', 'ISpeechPhraseElements', 'SPRECOSTATE',
    ...
    'ISpMMSysAudio', 'ISpeechPhraseReplacements', 'SpMMAudioOut',
    'DISPID_SRSClsidEngine', 'SBONone', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPEI_UNDEFINED',
    'DISPID_SDKCreateKey', 'SpResourceManager', 'SWTAdded',
    'SPEI_TTS_AUDIO_LEVEL', '_ISpeechVoiceEvents', 'DISPID_SGRsCount',
    'DISPID_SRGetFormat', 'SPAS_RUN', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRGState', 'SpeechRegistryLocalMachineRoot',
    'SPEVENTENUM', 'DISPID_SPEsItem', 'ISpRecoGrammar2',
    'DISPID_SGRSTsItem', 'SPDKL_CurrentUser',
    'DISPID_SPRuleFirstElement', 'SP_VISEME_16',
    'DISPID_SRCCreateGrammar', 'SGDSActiveWithAutoPause',
    'DISPID_SAEventHandle', 'SPGRAMMARWORDTYPE',
    'SpPhraseInfoBuilder', 'DISPID_SRCVoice',
    'DISPID_SRGDictationSetState', 'SP_VISEME_3', 'SPPS_RESERVED2',
    'SPRULE', 'SAFTCCITT_ALaw_8kHzStereo', 'SPAS_STOP',
    'DISPID_SGRsDynamic', 'DISPID_SPRuleParent', 'DISPID_SLPsItem',
    'SPINTERFERENCE_NOSIGNAL', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SGRs_NewEnum', 'SVSFNLPSpeakPunc', 'SPRST_ACTIVE',
    'DISPID_SVSLastBookmark', 'SPDKL_LocalMachine',
    'SWPKnownWordPronounceable', 'SpeechEngineConfidence',
    'eLEXTYPE_PRIVATE10', 'SGRSTTRule', 'DISPID_SVDisplayUI',
    'SVSFParseSsml', 'eLEXTYPE_PRIVATE11',
    'SpPhoneticAlphabetConverter', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRGReset', 'SPEI_SR_AUDIO_LEVEL', 'SDKLCurrentUser',
    'SREPropertyNumChange', 'SAFTCCITT_uLaw_8kHzMono',
    'SPGS_EXCLUSIVE', 'DISPID_SBSWrite', 'SAFT44kHz8BitMono',
    'SAFT8kHz16BitMono', 'eWORDTYPE_DELETED',
    'ISpeechRecognizerStatus', 'SPEI_RECO_STATE_CHANGE',
    'ISpEventSource', 'SVEAudioLevel', 'DISPID_SRRAudio',
    'SPINTERFERENCE', 'STSF_CommonAppData', 'SLTApp',
    'ISpeechPhraseReplacement', 'SFTInput',
    ...
    'SECHighConfidence', 'SVP_7', 'DISPID_SRCESoundStart',
    'DISPID_SGRAttributes', 'DISPID_SpeechRecognizer',
    'ISpeechXMLRecoResult', 'SPEI_MAX_TTS', 'DISPID_SPEPronunciation',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPERetainedStreamOffset', 'SREStreamEnd',
    'SpUnCompressedLexicon', 'SpStreamFormatConverter',
    'ISpObjectToken', 'SPVPRI_OVER', 'DISPID_SWFEAvgBytesPerSec',
    ...
    'SAFT12kHz8BitStereo', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPIGrammarId', 'SpObjectToken', 'DISPID_SLPPhoneIds',
    'SPSHORTCUTPAIR', 'SAFTNoAssignedFormat', 'SSTTWildcard',
    'SPINTERFERENCE_NONE', 'SPEI_SR_PRIVATE', 'DISPID_SLWWord',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE1', 'SpeechTokenKeyFiles',
    'SAFT16kHz8BitStereo', 'SPFILEMODE', 'DISPID_SpeechAudio',
    'SP_VISEME_9', 'DISPID_SVSkip', 'SREInterference', 'SREAllEvents',
    'SREPrivate', 'SITooSlow', 'SDA_One_Trailing_Space',
    'DISPID_SRCreateRecoContext', 'DISPID_SPEs_NewEnum',
    'DISPID_SpeechPhraseElements', 'SP_VISEME_21', 'SVP_11',
    'DISPID_SGRSTransitions', 'ISpRecoContext', 'SDTRule',
    ...
    'DISPID_SRGetPropertyNumber', 'SVSFPersistXML', 'SPEI_RESERVED3',
    'SSFMOpenForRead', 'DISPID_SGRSTNextState', 'SRTAutopause',
    'SPSHT_EMAIL', 'DISPID_SPRuleName', 'SpVoice',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPEActualConfidence', 'SPWF_INPUT',
    'DISPID_SpeechFileStream', 'DISPID_SBSRead', 'SRTReSent',
    'SPAUDIOOPTIONS', 'DISPID_SLPPartOfSpeech', 'SpInProcRecoContext',
    'DISPID_SLPsCount', 'DISPID_SpeechRecoResult2',
    'DISPID_SVGetAudioOutputs', 'SpeechVoiceCategoryTTSRate',
    'SPCT_COMMAND', 'SPSMF_SAPI_PROPERTIES', 'SP_VISEME_14',
    'SPSTREAMFORMATTYPE', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SRRSpeakAudio', 'SPWORDTYPE', 'SPEI_SENTENCE_BOUNDARY',
    'SGRSTTEpsilon', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPCT_SUB_DICTATION', 'DISPID_SWFEChannels',
    'DISPID_SPPNumberOfElements', 'DISPID_SPPName', 'SVP_3',
    'DISPID_SVVolume', 'SpeechCategoryRecoProfiles', 'DISPID_SOTId',
    'DISPID_SpeechPhraseElement', 'DISPID_SRProfile', 'SP_VISEME_20',
    'SVEWordBoundary', 'SAFTCCITT_uLaw_22kHzStereo',
    'SAFT11kHz8BitMono', 'eLEXTYPE_PRIVATE12', 'ISpObjectWithToken',
    'ISpeechPhraseElement', 'SPWORDLIST', 'SVP_21', 'SAFTText',
    'STSF_LocalAppData', 'DISPID_SVAlertBoundary',
    'DISPID_SLGetWords', 'SVF_Emphasis', 'SPAR_Medium',
    'ISpeechCustomStream', 'SPLEXICONTYPE', 'DISPID_SWFEExtraData',
    'SAFTCCITT_ALaw_11kHzMono', 'SPPHRASE',
    'DISPID_SRCEPropertyNumberChange', 'SpeechPropertyResponseSpeed',
    'DISPID_SPRsCount', 'SpeechDataKeyLocation',
    'DISPID_SPIAudioStreamPosition',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTExtendedAudioFormat', 'ISpeechPhoneConverter',
    'SSTTTextBuffer', 'SAFT44kHz16BitStereo', 'ISpRecoResult',
    'STCRemoteServer', 'DISPID_SABufferNotifySize',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCEInterference',
    'DISPID_SpeechGrammarRule', 'DISPID_SPACommit', 'SGLexical',
    'DISPID_SRGCmdSetRuleIdState', 'SpeechRuleAttributes',
    'SVSFIsFilename', 'SAFT11kHz16BitMono', 'SPEVENTSOURCEINFO',
    'SPAUDIOBUFFERINFO', 'SPSEMANTICERRORINFO',
    'IInternetSecurityMgrSite', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRCEBookmark', 'DISPID_SPEAudioSizeBytes', 'SpLexicon',
    'DISPID_SpeechAudioStatus', 'SAFT16kHz16BitMono',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPCT_DICTATION', 'SPSNotOverriden', 'SREBookmark',
    'DISPID_SRCEStartStream', 'ISpNotifySink', 'DISPID_SVResume',
    'ISpeechGrammarRules', 'DISPID_SGRSTRule', 'ISpNotifyTranslator',
    'DISPID_SPRNumberOfElements', 'SPSModifier', 'DISPID_SPRulesItem',
    'SPEI_SR_RETAINEDAUDIO', 'SASClosed',
    'DISPID_SPRuleNumberOfElements', 'ISpeechMMSysAudio',
    'SRTStandard', 'SAFT11kHz16BitStereo', 'SVP_15',
    'DISPID_SDKSetBinaryValue', 'SPSHT_NotOverriden',
    'SAFT48kHz16BitMono', 'SPSVerb', 'DISPID_SRIsShared',
    'SPEI_SR_BOOKMARK', 'DISPID_SRRSetTextFeedback',
    'SVEEndInputStream', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechGrammarRules', 'SPPS_Unknown',
    'SAFT12kHz16BitStereo', 'ISpSerializeState',
    'DISPID_SPRs_NewEnum', 'DISPID_SVSpeakCompleteEvent',
    'SpeechInterference', 'ISpeechWaveFormatEx', 'DISPID_SGRClear',
    'DISPID_SPELexicalForm', 'SVSFParseSapi', 'DISPID_SPILanguageId',
    'IStream', 'Speech_Max_Word_Length',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRCState',
    'ISpPhoneConverter', 'SRADynamic', 'SpeechFormatType',
    'DISPID_SRCERecognition', 'DISPID_SRRGetXMLResult',
    'ISpeechTextSelectionInformation', 'SPEI_RESERVED1',
    'SPGS_ENABLED', 'DISPID_SAVolume', 'DISPID_SPERetainedSizeBytes',
    'SpStream', 'SVP_14', 'ISpStream', 'DISPID_SAFGuid', 'SITooQuiet',
    'SPLO_STATIC', 'SpeechAudioState', 'ISpeechBaseStream',
    'DISPID_SRRAlternates', 'DISPID_SGRSTType', 'SREPhraseStart',
    'SpeechRunState', 'DISPID_SMSGetData',
    'DISPID_SVESentenceBoundary', 'SPPS_Function',
    'DISPID_SVEStreamEnd', 'DISPID_SpeechPhraseInfo',
    'DISPID_SGRsItem', 'SpTextSelectionInformation', 'DISPID_SPIRule',
    'DISPID_SLWs_NewEnum', 'SPWT_PRONUNCIATION', 'DISPIDSPRG',
    ...
    'SRAONone', 'DISPID_SRGCmdLoadFromFile', 'DISPID_SRSAudioStatus',
    'DISPID_SPPEngineConfidence', 'tagSPPROPERTYINFO',
    'ISpRecoContext2', 'SITooFast', 'SpeechLexiconType',
    'DISPID_SRGCmdLoadFromResource', 'SVP_0', 'DISPID_SDKEnumKeys',
    'SPDATAKEYLOCATION', 'SPAR_Low', 'SPEI_ADAPTATION',
    'SDKLLocalMachine', 'SPINTERFERENCE_TOOQUIET',
    'eLEXTYPE_RESERVED7', 'DISPID_SFSClose', 'DISPID_SOTCId',
    'DISPID_SGRsFindRule', 'DISPID_SpeechRecoContext',
    'SPPHRASEPROPERTY', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SAStatus', 'eLEXTYPE_PRIVATE20', 'DISPID_SADefaultFormat',
    'IEnumString', 'SPRS_ACTIVE', 'SpAudioFormat',
    'DISPID_SRCEPhraseStart', 'SPPS_Noun', 'SVSFIsXML',
    'SPVPRI_NORMAL', 'ISpRecognizer', 'DISPID_SVEventInterests',
    'SAFTGSM610_22kHzMono', 'DISPID_SDKSetStringValue',
    'SPCATEGORYTYPE', 'DISPID_SOTSetId', 'SpeechMicTraining',
    'DISPID_SpeechPhoneConverter', 'DISPID_SpeechMemoryStream',
    'DISPID_SRCEEndStream', 'SAFT8kHz8BitMono', 'SPSHT_OTHER',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVSVisemeId',
    'SPEI_VISEME', 'ISpeechGrammarRuleState', 'SECFIgnoreWidth',
    'SAFT8kHz8BitStereo', 'SRESoundStart', 'SPWAVEFORMATTYPE',
    'SPAR_Unknown', 'DISPID_SOTGetStorageFileName', 'SP_VISEME_5',
    'SpeechRecognitionType', 'DISPID_SRCResume', 'SpeechTokenContext',
    'ISpEventSink', 'SpeechRegistryUserRoot',
    'DISPID_SOTCreateInstance',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechLexiconWords', 'SPEI_MIN_TTS', 'eLEXTYPE_RESERVED4',
    'SpeechRecoEvents', 'SPSMF_UPS', 'DISPID_SRCBookmark',
    'eLEXTYPE_PRIVATE8', 'SDA_Consume_Leading_Spaces', 'SVP_17',
    'DISPID_SRAudioInputStream', 'DISPID_SRStatus',
    'SAFT32kHz8BitMono', 'ISpeechRecoResultDispatch',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRGRules',
    'DISPID_SLGetPronunciations', 'DISPID_SRCEHypothesis',
    'SPCONTEXTSTATE', 'SAFTCCITT_uLaw_22kHzMono', 'SPAUDIOSTATE',
    'IEnumSpObjectTokens', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechAudioVolume', 'SpeechVoicePriority',
    'SAFTGSM610_11kHzMono', 'DISPID_SRDisplayUI', 'SpeechVoiceEvents',
    'SAFTDefault', 'SVP_20', 'SAFT16kHz16BitStereo', 'ISpRecognizer3',
    'SpeechCategoryAudioOut', 'SpeechDisplayAttributes',
    'DISPID_SGRSTs_NewEnum', 'SPWORDPRONOUNCEABLE', 'ISpDataKey',
    'SSFMCreate', 'SAFTGSM610_8kHzMono', 'SAFT22kHz16BitStereo',
    'SpObjectTokenCategory', 'SPCS_DISABLED', 'SPPS_Verb',
    'SVEViseme', 'DISPID_SOTCDefault', 'DISPID_SVSLastBookmarkId',
    'DISPID_SWFEFormatTag', 'DISPID_SDKSetLongValue', 'SINoSignal',
    'SPVPRI_ALERT', 'DISPID_SpeechLexicon', 'SPSERIALIZEDPHRASE',
    'SDTProperty', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SGRSTWeight', 'ISpeechPhraseProperty', 'SVP_2',
    'SVEStartInputStream', 'ISpeechObjectTokenCategory',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SGSDisabled',
    'DISPID_SPEAudioTimeOffset', 'SpeechVoiceSpeakFlags',
    'SAFTADPCM_22kHzMono', 'SPPS_NotOverriden', 'SpFileStream',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechTokenKeyAttributes',
    'DISPID_SVAudioOutput', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPIDSPTSI_ActiveLength', 'SPPS_RESERVED1', 'SPCT_SUB_COMMAND',
    'DISPID_SPEsCount', 'ISpPhrase', 'DISPID_SPEDisplayAttributes',
    'DISPID_SOTCGetDataKey', 'SpWaveFormatEx', 'SVSFParseMask',
    'SAFT44kHz8BitStereo', 'DISPID_SRCERequestUI',
    'SpeechGrammarTagDictation', 'SPEI_REQUEST_UI', 'SRSEIsSpeaking',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'eLEXTYPE_PRIVATE6',
    'SSSPTRelativeToCurrentPosition', 'SVP_8',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVGetVoices', 'SDTAll',
    'SREStateChange', 'DISPID_SOTsCount', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechLexiconProns', 'SVEPhoneme', 'SPAR_High',
    'SPFM_NUM_MODES', 'ISpResourceManager',
    'DISPIDSPTSI_SelectionLength', 'SAFTNonStandardFormat',
    'DISPID_SPIEngineId', 'DISPID_SOTDataKey', 'DISPID_SGRAddState',
    'SpeechStreamSeekPositionType', 'DISPID_SRRAudioFormat',
    'SRAInterpreter', 'SASPause', 'SVSFDefault',
    'SAFT48kHz16BitStereo', 'ISpeechAudioFormat',
    'DISPID_SOTCategory', 'ISpeechPhraseProperties',
    'SPEI_PHRASE_START', 'SPVOICESTATUS', 'SPPS_RESERVED3',
    'ISpeechRecoGrammar', 'DISPID_SWFEBitsPerSample',
    'STSF_FlagCreate', 'DISPID_SRCCmdMaxAlternates',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SOTIsUISupported',
    'SINoise', 'DISPID_SVEBookmark', 'SpeechCategoryPhoneConverters',
    'SPEI_SOUND_END', 'DISPID_SVSpeakStream', 'DISPID_SLWsItem',
    'SPPS_Modifier', 'ISpeechLexiconPronunciations',
    'SpSharedRecoContext', 'DISPID_SVSInputWordLength',
    'DISPID_SPRFirstElement', 'SpeechEmulationCompareFlags',
    'DISPID_SRCEventInterests', 'SPSHT_Unknown',
    'DISPID_SPIReplacements', 'SPBO_AHEAD', 'DISPID_SOTs_NewEnum',
    'SPPHRASERULE', 'DISPID_SpeechPhraseBuilder', 'DISPID_SLWLangId',
    'SDTPronunciation', 'SAFT48kHz8BitStereo', 'ISpeechRecoResult2',
    'SPEI_SOUND_START', '__MIDL_IWinTypes_0009', 'SRERequestUI',
    'DISPID_SMSALineId', 'Speech_Default_Weight',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SPRsItem',
    'SPSUnknown', 'SpeechAudioFormatType', 'SWTDeleted',
    'SpeechStreamFileMode', 'DISPID_SRSSupportedLanguages',
    'ISpeechRecoContext', 'DISPID_SOTsItem', 'SGRSTTWildcard',
    'SAFTADPCM_44kHzMono', 'SVF_Stressed', 'DISPID_SASState',
    'SPSFunction', 'DISPID_SPEAudioSizeTime', 'SECFNoSpecialChars',
    'SpeechTokenKeyUI', 'SVP_18', 'SSFMOpenReadWrite',
    'SPSEMANTICFORMAT', 'SPVISEMES',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SGRsAdd',
    'SP_VISEME_0', 'SVSFVoiceMask', 'DISPID_SVEEnginePrivate',
    'STCInprocServer', 'SPLO_DYNAMIC', 'DISPID_SVEAudioLevel',
    'SAFT24kHz16BitMono', 'SpCustomStream', 'SP_VISEME_18',
    'DISPID_SVSInputWordPosition', 'DISPID_SRIsUISupported',
    'DISPID_SRSetPropertyString', 'SVEBookmark',
    'SAFTADPCM_11kHzStereo', 'SVP_12', 'ISpeechPhraseAlternate',
    'DISPID_SWFESamplesPerSec', 'SPEI_RESERVED6', 'ISpRecognizer2',
    'DISPID_SPRuleId', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SABIMinNotification', 'ISpeechAudioBufferInfo',
    'SREPropertyStringChange', 'DISPID_SDKDeleteValue',
    'DISPID_SGRInitialState', 'DISPID_SPIAudioSizeBytes',
    'ISpeechRecognizer', 'SpeechTokenValueCLSID',
    'SAFT32kHz16BitMono', 'SAFT24kHz8BitMono', 'ISpeechFileStream',
    'DISPID_SLWsCount', 'SP_VISEME_6', 'SDKLCurrentConfig',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRCEAudioLevel',
    'SpeechGrammarWordType', 'SPBO_NONE', 'SAFTCCITT_ALaw_22kHzMono',
    ...
    'SpeechCategoryVoices', 'SVSFlagsAsync', 'DISPID_SPPId',
    'DISPID_SVSpeak', 'SPSInterjection',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRGDictationLoad',
    'SAFTCCITT_ALaw_44kHzMono', 'SDTLexicalForm',
    'DISPID_SpeechDataKey', 'SpeechBookmarkOptions',
    'SpeechCategoryRecognizers', 'ISpeechLexiconWord', 'SGDSInactive',
    'SPEI_TTS_PRIVATE', 'ISpeechPhraseAlternates',
    'DISPID_SRAudioInput', 'DISPID_SGRSTPropertyName',
    'eLEXTYPE_PRIVATE14', 'SGDisplay', 'ISpStreamFormatConverter',
    'SRAExport', 'SAFT44kHz16BitMono', 'SpeechWordType',
    'SPEI_WORD_BOUNDARY', 'SRSActiveAlways',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPCLangId',
    'DISPID_SPIProperties', 'DISPID_SVEStreamStart', 'SVP_16',
    'SPSERIALIZEDRESULT', 'DISPID_SRState', 'DISPID_SRGId',
    'DISPID_SpeechObjectToken', 'SECFDefault',
    'DISPID_SOTGetAttribute', 'SPPROPERTYINFO',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRCEEnginePrivate',
    'SpeechSpecialTransitionType', 'DISPID_SVEVoiceChange',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SVPriority',
    'SPEI_RESERVED2', 'DISPID_SRRecognizer', 'DISPID_SPIStartTime',
    'SRSEDone', 'DISPID_SRSetPropertyNumber', 'ISpeechObjectToken',
    'ISpStreamFormat', 'SDTAudio', 'SpeechRecognizerState',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPRText',
    'DISPID_SRGCommit', 'DISPID_SDKGetlongValue',
    'SPINTERFERENCE_NOISE', 'SRARoot', 'DISPID_SPPChildren',
    'SECFEmulateResult', 'SPWORDPRONUNCIATION',
    'IInternetSecurityManager', 'SpeechEngineProperties',
    'DISPID_SLGetGenerationChange', '_SPAUDIOSTATE', 'SPWT_DISPLAY',
    'eLEXTYPE_PRIVATE5', 'SPEI_START_INPUT_STREAM', 'DISPIDSPTSI',
    'SLTUser', 'DISPID_SRRTLength', 'SpeechGrammarTagWildcard',
    'ISpVoice', 'DISPID_SDKGetStringValue',
    'DISPID_SpeechRecoContextEvents', 'SpeechDiscardType',
    'SpMMAudioIn', 'DISPID_SRRPhraseInfo', 'ISpAudio',
    'DISPID_SPPConfidence', 'DISPID_SpeechPhraseReplacements',
    'eLEXTYPE_PRIVATE16', 'DISPID_SGRSTText', 'SASRun',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'eLEXTYPE_PRIVATE9',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SMSAMMHandle', 'SVP_1',
    'SpeechRecoProfileProperties', 'SPCT_SLEEP',
    'DISPID_SRCRecognizer', 'SAFT12kHz16BitMono', 'SpeechRuleState',
    'ISpeechVoice', 'SPFM_CREATE_ALWAYS', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRCRetainedAudioFormat',
    'SDTAlternates', 'SpeechAudioFormatGUIDText',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCEAdaptation', 'DISPID_SPRulesCount',
    'SAFT12kHz8BitMono', 'SPBO_TIME_UNITS',
    'DISPID_SPAStartElementInResult', 'SPINTERFERENCE_TOOLOUD',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPRuleConfidence',
    'SpeechAudioProperties', 'DISPID_SpeechObjectTokenCategory',
    'SINone', 'DISPID_SPANumberOfElementsInResult',
    'SpeechPropertyNormalConfidenceThreshold', 'SVP_4',
    'DISPID_SVSPhonemeId', 'SREStreamStart', 'SP_VISEME_7',
    'SpNotifyTranslator', 'eLEXTYPE_PRIVATE7', 'SRAImport',
    'DISPID_SAFType', 'SAFT48kHz8BitMono', 'SPAS_PAUSE',
    'DISPID_SWFEBlockAlign', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPFM_OPEN_READONLY', 'ISpeechGrammarRule', 'SRERecoOtherContext',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVSFPurgeBeforeSpeak',
    'DISPID_SVRate', 'DISPID_SABIEventBias', 'Speech_Max_Pron_Length',
    'DISPID_SVIsUISupported', 'SECNormalConfidence', 'SVEVoiceChange',
    ...
    'SDKLDefaultLocation', 'DISPID_SVEViseme',
    'SpeechPropertyLowConfidenceThreshold', 'SGRSTTDictation',
    'SECFIgnoreKanaType', 'SDTDisplayText', 'SAFT8kHz16BitStereo',
    'DISPID_SPEEngineConfidence', 'SpeechDictationTopicSpelling',
    'DISPID_SRCRetainedAudio', 'SGSEnabled', 'SPPS_SuppressWord',
    'ISpLexicon', 'SPSSuppressWord', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFT22kHz16BitMono', 'ISpGrammarBuilder', 'ISpeechObjectTokens',
    'SVSFUnusedFlags', 'SpeechPropertyHighConfidenceThreshold',
    'SRCS_Enabled', 'DISPID_SpeechBaseStream', 'SVEPrivate',
    'DISPID_SMSSetData', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SLAddPronunciation', 'DISPID_SRCSetAdaptationData',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SASetState', 'SVPAlert',
    'DISPID_SGRSRule', 'SPEI_MIN_SR', 'ISpRecoGrammar',
    'DISPID_SVWaitUntilDone', 'SWPUnknownWordPronounceable',
    'SPRS_INACTIVE', 'SAFT24kHz16BitStereo',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SOTDisplayUI', 'SPPS_Noncontent',
    'DISPID_SVSRunningState', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRRTTickCount', 'DISPID_SpeechRecoResult', 'SPRULESTATE',
    'DISPID_SGRSTPropertyValue', 'SRSInactiveWithPurge',
    'DISPID_SVSCurrentStreamNumber', 'SPRECOGNIZERSTATUS',
    'SpInprocRecognizer', 'DISPID_SLWType', 'SRADefaultToActive',
    'DISPID_SVGetProfiles', 'SAFTADPCM_8kHzStereo', 'SVEAllEvents',
    'SPLOADOPTIONS', 'DISPID_SABIBufferSize', 'SRAORetainAudio',
    'SAFTADPCM_44kHzStereo', 'SPWT_LEXICAL', 'SPSHORTCUTTYPE',
    '_ISpeechRecoContextEvents', 'SPVPRIORITY', 'SPAO_NONE',
    'ISpNotifySource', 'SVPOver', 'SPEI_RECOGNITION',
    'DISPID_SOTRemoveStorageFileName', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPIRetainedSizeBytes', 'SGPronounciation',
    'DISPID_SpeechAudioFormat', 'SPWF_SRENGINE', 'DISPID_SLPType',
    'SPPHRASEELEMENT', 'SREHypothesis', 'DISPID_SOTGetDescription',
    ...
    'SpCompressedLexicon', 'DISPID_SGRName', 'SPAUDIOSTATUS',
    'SPRST_INACTIVE', 'DISPID_SRGSetTextSelection',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPPValue', 'SPEI_HYPOTHESIS', 'SP_VISEME_2',
    'SAFTGSM610_44kHzMono', 'SpeechVisemeType', 'DISPID_SOTRemove',
    'SASStop', 'DISPID_SRRSaveToMemory', 'tagSTATSTG', 'SBOPause',
    'DISPID_SpeechLexiconWord', 'DISPID_SCSBaseStream',
    'SAFT22kHz8BitStereo', 'SAFT16kHz8BitMono',
    'SPEI_FALSE_RECOGNITION', 'ISpXMLRecoResult',
    'eLEXTYPE_USER_SHORTCUT', 'eLEXTYPE_RESERVED9',
    'DISPID_SRRRecoContext', 'SFTSREngine', 'ISpeechVoiceStatus',
    'SPCS_ENABLED', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPIGetText', 'eLEXTYPE_PRIVATE18', 'SpeechUserTraining',
    'DISPID_SPARecoResult', 'SAFT32kHz16BitStereo',
    'DISPID_SPAs_NewEnum', 'SRCS_Disabled',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechRecoResult', 'SRTSMLTimeout',
    'eLEXTYPE_PRIVATE3', 'SP_VISEME_1', 'SPGRAMMARSTATE',
    'DISPID_SOTCSetId', 'DISPID_SRGRecoContext',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SLWPronunciations',
    'Speech_StreamPos_RealTime', 'SVP_13',
    'SpeechCategoryAppLexicons', 'SP_VISEME_10', 'DISPID_SVEWord',
    'SITooLoud', 'eLEXTYPE_PRIVATE19', 'Speech_StreamPos_Asap',
    'SPBOOKMARKOPTIONS', 'DISPID_SRCPause', 'SVP_6',
    'DISPID_SLGenerationId', 'SECLowConfidence', 'SpMMAudioEnum',
    'SP_VISEME_8', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechGrammarState', 'SGRSTTWord', 'DISPID_SDKOpenKey',
    'WAVEFORMATEX', 'DISPID_SASCurrentSeekPosition',
    'ISpeechRecoResultTimes', 'SPXRO_Alternates_SML',
    'SpeechAddRemoveWord', 'SPPS_RESERVED4', 'DISPID_SPPs_NewEnum',
    'SVP_5', 'SPPS_LMA', 'SRTEmulated', 'DISPID_SRGetRecognizers',
    'SpeechCategoryAudioIn', 'SVPNormal', 'SPEI_TTS_BOOKMARK',
    'SPAO_RETAIN_AUDIO', 'SpeechRecoContextState',
    'DISPID_SAFSetWaveFormatEx', 'SRSActive', 'SSTTDictation',
    'DISPID_SGRSTsCount', 'DISPID_SPEDisplayText',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SpeechVoiceEvent',
    'SP_VISEME_19', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPAsCount',
    'DISPID_SPRuleChildren', 'DISPID_SOTMatchesAttributes',
    'SpeechLoadOption', 'ISpeechAudioStatus', 'ISpeechPhraseRules',
    'SPRECOCONTEXTSTATUS', 'DISPIDSPTSI_ActiveOffset',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRCEFalseRecognition',
    'SPEI_PROPERTY_STRING_CHANGE', 'SGDSActiveUserDelimited',
    'SPEVENT', 'SP_VISEME_12', 'DISPID_SASNonBlockingIO',
    '_RemotableHandle', 'DISPID_SDKEnumValues',
    'SpeechPropertyAdaptationOn', 'SVSFNLPMask', 'DISPID_SPAsItem',
    'SVF_None', 'SPRST_NUM_STATES', 'eLEXTYPE_PRIVATE4',
    'SSSPTRelativeToEnd', 'ISpeechAudio', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpRecoCategory',
    'SGLexicalNoSpecialChars', 'DISPID_SPPFirstElement',
    'DISPID_SVVoice', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCESoundEnd',
    'DISPID_SGRSTPropertyId', 'SPEI_END_SR_STREAM', 'SRATopLevel',
    'ISpProperties', 'LONG_PTR', 'DISPID_SBSFormat',
    'DISPID_SASFreeBufferSpace', 'SAFT22kHz8BitMono',
    'SDTReplacement', 'DISPID_SPCPhoneToId', 'DISPID_SMSADeviceId',
    'STCLocalServer', 'SpeechPropertyResourceUsage',
    'SAFTADPCM_11kHzMono', 'UINT_PTR', 'SPAS_CLOSED',
    'DISPID_SPPsItem', 'DISPID_SVAudioOutputStream',
    'DISPID_SLPLangId', 'eLEXTYPE_APP', 'DISPID_SpeechCustomStream',
    'SDA_No_Trailing_Space', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVSInputSentencePosition', 'SPEI_VOICE_CHANGE',
    'SpeechTokenShellFolder', 'DISPID_SRRDiscardResultInfo',
    'SPRST_ACTIVE_ALWAYS', 'SLOStatic', 'SPPHRASEREPLACEMENT',
    'STSF_AppData', 'SVSFParseAutodetect', 'SAFT11kHz8BitStereo',
    'SpMemoryStream', 'SPDKL_DefaultLocation',
    'SpeechTokenIdUserLexicon', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SASCurrentDevicePosition', 'SRERecognition',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SREmulateRecognition',
    'SSFMCreateForWrite', 'SPEI_INTERFERENCE', 'SPEI_RESERVED5',
    'SPEI_PHONEME', 'DISPID_SpeechVoice', 'SPWORD',
    'DISPID_SVSLastResult', 'ISpeechPhraseInfoBuilder',
    'SP_VISEME_17', 'eLEXTYPE_RESERVED10',
    'DISPID_SLRemovePronunciation', 'STCInprocHandler',
    'SPINTERFERENCE_TOOFAST', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPPsCount',
    'eLEXTYPE_MORPHOLOGY', 'SPFM_OPEN_READWRITE',
    'SREFalseRecognition', 'DISPID_SDKDeleteKey', 'DISPID_SGRsCommit',
    'SSSPTRelativeToStart', 'SRESoundEnd',
    'ISpeechGrammarRuleStateTransition', 'SPRECORESULTTIMES',
    'SPFM_CREATE', 'SPSLMA', 'SPBINARYGRAMMAR', 'DISPID_SPPParent',
    'SRSInactive', 'DISPID_SVPause', 'SpPhoneConverter',
    'SPXMLRESULTOPTIONS', 'DISPID_SLPSymbolic',
    'DISPIDSPTSI_SelectionOffset', 'ISpShortcut',
    'SAFT24kHz8BitStereo', 'eLEXTYPE_PRIVATE17', 'DISPID_SGRId',
    'ISpeechResourceLoader', 'eWORDTYPE_ADDED', 'ISpeechLexicon',
    'SPXRO_SML', 'ISpeechMemoryStream', 'SPEI_MAX_SR', 'SVP_10',
    'DISPID_SVEPhoneme', 'SpeechWordPronounceable', 'DISPID_SVStatus',
    'ISpPhraseAlt', 'ISpeechPhraseRule', 'SGRSTTTextBuffer',
    'SWPUnknownWordUnpronounceable', 'SpeechPartOfSpeech',
    'SAFT32kHz8BitStereo', 'SPPS_Interjection', 'SPDKL_CurrentConfig',
    'DISPID_SpeechPhraseRules', 'ISpeechDataKey',
    'SPTEXTSELECTIONINFO', 'SP_VISEME_4', 'eLEXTYPE_RESERVED8',
    'SpShortcut'
]
